...
#define STRING_CONFIG_H_AUTHOR "(Dennis Witzig, Ender-3 V2)" // Who made the changes.
...
#define MACHINE_UUID "25b1bff2-8f66-4e97-a925-ad58e06f5e23"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 9.7f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.279f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.081f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.092f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
  ...
  #define FILAMENT_HEAT_CAPACITY_PERMM { 5.15e-3f }    // 0.0056 J/K/mm for 1.75mm PLA (0.0149 J/K/mm for 2.85mm PLA).
...
#define PIDTEMPBED
  ...
  // Ender-3 V2
  #define DEFAULT_bedKp 116.5
  #define DEFAULT_bedKi  8.83
  #define DEFAULT_bedKd 480.3
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -7, -1.95 }
